...
python3 test_whisper.py "base.en" $AUDIO_FILE $TRANSCRIPT_FILE
python3 test_whisper.py "base" $AUDIO_FILE $TRANSCRIPT_FILE
python3 test_whisper.py "small.en" $AUDIO_FILE $TRANSCRIPT_FILE
python3 test_whisper.py "small" $AUDIO_FILE $TRANSCRIPT_FILE
